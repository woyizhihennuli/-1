...
-- @Last Modified time: 2023-03-07 09:44:04
...
function 商店处理类:初始化()
	...
	self.商品列表={}
		...
		self.商品列表[18]={"秘制红罗羹*200000","秘制绿罗羹*200000"}
		...
		self.商品列表[26]={"青龙石*20","白虎石*20","朱雀石*20","玄武石*20","彩果*50","金柳露*30","超级金柳露*50","魔兽要诀*30","高级魔兽要诀*500","神兜兜*500","点化石*100","附魔宝珠*100"}
...
function 商店处理类:设置神秘宝箱(id)
	...
	elseif 奖励<=390 then
  	...
  	神秘宝箱[id]={
  		...
  		[3]={
  			名称="随机宝石二",
 			说明="散发着宝石的光华，右键打开，可以获得4~8级随机宝石一颗",
 			备注="随机4-8级宝石"
  		},
  		[4]={
  			名称="灵饰指南书",
  		...
  		[7]={
  			名称="随机宝石一",
 			说明="散发着宝石的光华，右键打开，可以获得1~5级随机宝石一颗",
 			备注="随机1-5级宝石"
  		},
  		[8]={
  			名称="新仙玉锦囊",
