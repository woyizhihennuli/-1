...
-- @Last Modified time: 2023-08-03 18:42:41
--======================================================================--
--======================================================================--
 ...
 if 取队长权限(数字id)==false then return  end
  ...
  elseif 类型==101 then
    if 事件=="少说废话,开打" then
      ...
      if 活动次数查询(数字id,"封妖战斗")==false then return  end
  ...
  elseif 类型==102 then
    if 事件=="我来领养你" then
      ...
      if 取等级要求(数字id,69)==false then 常规提示(数字id,"#Y/至少要达到69级") return  end
  ...
  elseif 类型==104 then
    if 事件=="请星君赐教" then
      ...
      if 取等级要求(数字id,30)==false then 常规提示(数字id,"#Y/挑战本星君至少要达到30级") return  end
      if 活动次数查询(数字id,"星宿")==false then return  end
  ...
  elseif 类型==105 then
    if 事件=="让我来收拾你" then
      ...
      if 取等级要求(数字id,30)==false then 常规提示(数字id,"#Y/降服妖魔鬼怪至少要达到30级") return  end
      if 活动次数查询(数字id,"妖魔鬼怪")==false then return  end
  ...
  elseif 类型==106 then
    if 事件=="请出招吧" then
      ...
      if 取等级要求(数字id,30)==false then 常规提示(数字id,"#Y/进行门派闯关活动至少要达到30级") return  end
      --检查任务一致
  ...
  elseif 类型==108 then
    if 事件=="我要报道" then
      ...
      if 活动次数查询(数字id,"游泳比赛")==false then return  end
      if 玩家数据[数字id].队伍==0 then 常规提示(数字id,"#Y必须组队才能触发该活动") return end
      if 取队伍人数(数字id)<3 then 常规提示(数字id,"#Y/进行游泳比赛活动最少必须由三人进行") return  end
      if 取等级要求(数字id,30)==false then 常规提示(数字id,"#Y/进行游泳比赛活动至少要达到30级") return  end
      --检查任务一致
  ...
  elseif 类型==200 then
    if 事件=="我要降服你" then
      if 任务数据[玩家数据[数字id].地图单位.标识].战斗~=nil then 常规提示(数字id,"#Y/对方正在战斗中") return  end
      if 活动次数查询(数字id,"降妖伏魔")==false then return  end
      if 玩家数据[数字id].队伍==nil then
        常规提示(数字id,"#Y/请先组队！")
        return
      end
  ...
  elseif 类型==205 then
    if 事件=="休得在此放肆" then
      ...
      if 取等级要求(数字id,30)==false then 常规提示(数字id,"#Y/降服妖王至少要达到30级") return  end
      if 活动次数查询(数字id,"妖王")==false then return  end
  ...
  elseif 类型==209 then
    if 事件=="我岂是贪污受贿之人" then
      if 任务数据[玩家数据[数字id].地图单位.标识].战斗~=nil then 常规提示(数字id,"#Y/对方正在战斗中") return  end
      if 活动次数查询(数字id,"三界悬赏令")==false then return  end
  ...
  elseif 类型==206 then
    if 事件=="我们准备好了" then
      ...
      if 取等级要求(数字id,109)==false then 常规提示(数字id,"#Y/队伍中有成员等级不符合要求") return  end
      if 活动次数查询(数字id,"世界BOSS")==false then return  end
  ...
  elseif 类型==210 then
    if 事件=="知了还这么嚣张？讨打！" then
      if 任务数据[玩家数据[数字id].地图单位.标识].战斗~=nil then 常规提示(数字id,"#Y/对方正在战斗中") return  end
      if 玩家数据[数字id].队伍==0 then 常规提示(数字id,"#Y必须组队才能触发该活动") return end
      if 取队伍人数(数字id)<1 then 常规提示(数字id,"#Y挑战该活动最少必须由五人进行") return  end
      if 取等级要求(数字id,69)==false then 常规提示(数字id,"#Y/队伍中有成员等级不符合要求") return  end
      if 活动次数查询(数字id,"知了王")==false then return  end
  ...
  elseif 类型==128 then
    if 事件=="神仙不做,看来我要抓你回天庭" then
      ...
      if 玩家数据[数字id].队伍==0 then 常规提示(数字id,"#Y必须组队才能触发该活动") return end
      if 取队伍人数(数字id)<1 then 常规提示(数字id,"#Y队伍人数低于3人，无法进入战斗") return  end
      if 取队伍最低等级(玩家数据[数字id].队伍,69) then 常规提示(数字id,"#Y队伍有玩家等级低于69级，无法进入战斗") return end
      if 活动次数查询(数字id,"天庭叛逆")==false then return  end
      任务数据[玩家数据[数字id].地图单位.标识].战斗=true
  ...
  elseif 类型==129 then
    if 事件=="三天不打,你又上房揭瓦了?" then
      ...
      if 取队伍人数(数字id)<1 then 常规提示(数字id,"#Y队伍人数低于3人，无法进入战斗") return  end
      if 取队伍最低等级(玩家数据[数字id].队伍,69) then 常规提示(数字id,"#Y队伍有玩家等级低于69级，无法进入战斗") return end
      if 活动次数查询(数字id,"扰乱水果")==false then return  end
  ...
  elseif 类型==141 then
    if 事件=="不知悔改，看我如何收服你" then
      if 活动次数查询(数字id,"车迟副本")==false then return end
      if 任务数据[玩家数据[数字id].地图单位.标识].战斗~=nil then 常规提示(数字id,"#Y/对方正在战斗中") return  end
      if 玩家数据[数字id].队伍==0 then 常规提示(数字id,"#Y必须组队才能触发该活动") return end
      if 取队伍人数(数字id)<1 then 常规提示(数字id,"#Y队伍人数低于3人，无法进入战斗") return  end
      任务数据[玩家数据[数字id].地图单位.标识].战斗=true
    ...
    if 事件=="除魔卫道是我们应尽的职责" then
      ...
      local 任务id=玩家数据[数字id].角色:取任务(150)
        for i=1,#队伍数据[玩家数据[数字id].队伍].成员数据 do
          ...
          if 副本奖励[队伍数据[玩家数据[数字id].队伍].成员数据[i]]==nil or 副本奖励[队伍数据[玩家数据[数字id].队伍].成员数据[i]].水陆奖励==nil then
             副本奖励[队伍数据[玩家数据[数字id].队伍].成员数据[i]].水陆奖励=true
             end
  ...
  elseif 类型==304 then
    if 事件=="我们准备好了" then
      ...
      if 取等级要求(数字id,69)==false then 常规提示(数字id,"#Y/挑战地煞星至少要达到69级") return  end
      if 活动次数查询(数字id,"地煞星")==false then return  end
  ...
  elseif 类型==305 then
    if 事件=="小小先锋还这么嚣张？讨打！" then
      ...
      if 活动次数查询(数字id,"知了先锋")==false then return  end
  ...
  elseif 类型==314 then
    if 事件=="请星君赐教" then
      ...
      if 取等级要求(数字id,109)==false then 常规提示(数字id,"#Y/队伍中有成员等级不符合要求") return  end
      if 活动次数查询(数字id,"天罡星")==false then return  end
  ...
  elseif 类型==337 then
    if 事件=="我来领取福利" then
      ...
      if 取等级要求(数字id,40)==false then 常规提示(数字id,"#Y/大于40级的玩家才能挑战哦") return  end
  ...
  elseif 类型==356 then
    if 事件=="小小年兽" then
      ...
      if 取等级要求(数字id,50)==false then 常规提示(数字id,"#Y/挑战小年兽至少要达到50级") return  end
  ...
  elseif 类型==357 then
    if 事件=="打倒年兽" then
      ...
      if 玩家数据[数字id].队伍==0 then 常规提示(数字id,"#Y必须组队才能触发该活动") return end
      if 取队伍人数(数字id)<2 then 常规提示(数字id,"#Y挑战次任务最少必须由两人进行") return  end
      if 取等级要求(数字id,69)==false then 常规提示(数字id,"#Y/进挑战年兽王至少要达到69级") return  end
      -- if 取等级要求(数字id,任务数据[玩家数据[数字id].地图单位.标识].等级)==false then 常规提示(数字id,"#Y/队伍中有成员等级不符合要求") return  end
  ...
  elseif 类型==193 then
    if 事件=="我看谁敢" then
      if 任务数据[玩家数据[数字id].地图单位.标识].战斗~=nil then 常规提示(数字id,"#Y/对方正在战斗中") return  end
      if 玩家数据[数字id].队伍==0 then 常规提示(数字id,"#Y必须组队才能触发该活动") return end
      if 取队伍人数(数字id)<1 then 常规提示(数字id,"#Y/此任务最少要有1人组队") return  end
  ...
  elseif 类型==185 then
    if 事件=="定" then
      if 任务数据[玩家数据[数字id].地图单位.标识].战斗~=nil then 常规提示(数字id,"#Y/对方正在战斗中") return  end
      if 玩家数据[数字id].队伍==0 then 常规提示(数字id,"#Y必须组队才能触发该活动") return end
      if 取队伍人数(数字id)<3 then 常规提示(数字id,"#Y/挑战此任务最少要有3人") return  end
  ...
  elseif 类型==8817 then
    if 事件=="我这就去阻止蚩尤的阴谋" then
      if 剧情数据.渡劫.进行[数字id].进程==12 then
        地图处理类:跳转地图(数字id,1206,133,81)
        剧情数据.渡劫.进行[数字id].进程=13
        任务处理类:取渡劫任务(数字id)
        玩家数据[数字id].角色:刷新任务跟踪()
        return
      elseif 剧情数据.渡劫.进行[数字id].进程==13 then
        地图处理类:跳转地图(数字id,1206,133,81)
        return
      end
    end
--嘎嘎 开服
  elseif 类型==1994 then
    if 事件=="你装尼玛呢" then
      if 任务数据[玩家数据[数字id].地图单位.标识].战斗~=nil then 常规提示(数字id,"#Y/对方正在战斗中") return  end
      if 玩家数据[数字id].队伍==0 then 常规提示(数字id,"#Y必须组队才能触发该活动") return end
      if 取队伍人数(数字id)<1 then 常规提示(数字id,"#Y挑战跨服怪最少必须由1人进行") return  end
      if 取等级要求(数字id,69)==false then 常规提示(数字id,"#Y/挑战跨服怪至少要达到69级") return  end
      --if 活动次数查询(数字id,"地煞星")==false then return  end
      战斗准备类:创建战斗(数字id+0,199406,玩家数据[数字id].地图单位.标识)
      任务数据[玩家数据[数字id].地图单位.标识].战斗=true
      玩家数据[数字id].地图单位=nil
      return
    end
