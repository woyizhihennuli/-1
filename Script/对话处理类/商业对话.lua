...
-- @Last Modified time: 2022-10-11 18:38:47
...
function 场景类_对话商业栏:购买商品1(连接id,id,序号,内容)
  ...
  for n=1,商品数量 do
    ...
    if 商品名称=="高级魔兽要诀" then
    玩家数据[id].道具:给予道具(id,"高级魔兽要诀")
    广播消息({内容=format("#G听说#R/#G%s#Y在傲来国的渔夫处花重金购买了#Y%s#24",玩家数据[id].角色.数据.名称,商品名称),频道="cw"})
    elseif 商品名称=="魔兽要诀" then
    玩家数据[id].道具:给予道具(id,"魔兽要诀")
    广播消息({内容=format("#G听说#R/#G%s#Y在傲来国的渔夫处花重金购买了#Y%s#24",玩家数据[id].角色.数据.名称,"魔兽要诀"),频道="cw"})
    elseif 商品名称=="点化石" then
    玩家数据[id].道具:给予道具(id,"点化石")
    广播消息({内容=format("#G听说#R/#G%s#Y在傲来国的渔夫处花重金购买了#Y%s#24",玩家数据[id].角色.数据.名称,"点化石"),频道="cw"})
    elseif 商品名称=="附魔宝珠" then
    玩家数据[id].道具:给予道具(id,"附魔宝珠",1)
    广播消息({内容=format("#G听说#R/#G%s#Y在傲来国的渔夫处花重金购买了#Y%s#24",玩家数据[id].角色.数据.名称,"附魔宝珠"),频道="cw"})
    elseif 商品名称=="神兜兜" then
    玩家数据[id].道具:给予道具(id,"神兜兜",1)
    广播消息({内容=format("#G听说#R/#G%s#Y在傲来国的渔夫处花重金购买了#Y%s#24",玩家数据[id].角色.数据.名称,"神兜兜"),频道="cw"})
    elseif 商品名称=="金柳露" then
    玩家数据[id].道具:给予道具(id,"金柳露",1)
    广播消息({内容=format("#G听说#R/#G%s#Y在傲来国的渔夫处花重金购买了#Y%s#24",玩家数据[id].角色.数据.名称,"金柳露"),频道="cw"})
    elseif 商品名称=="超级金柳露" then
    玩家数据[id].道具:给予道具(id,"超级金柳露",1)
    广播消息({内容=format("#G听说#R/#G%s#Y在傲来国的渔夫处花重金购买了#Y%s#24",玩家数据[id].角色.数据.名称,"超级金柳露"),频道="cw"})
      else
    道具编号=玩家数据[id].道具:取新编号()
    玩家数据[id].道具.数据[道具编号]=复制物品(商品道具)
    玩家数据[id].角色.数据.道具[道具格子]=道具编号
