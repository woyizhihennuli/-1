...
-- @Last Modified time: 2023-05-26 15:39:44
--======================================================================--
-- @作者: GGE研究群: 342119466
-- @创建时间:   2018-03-03 02:34:19
-- @Last Modified time: 2022-08-11 14:43:13
...
function 取野怪(map)--########################################################?自己修改?##########################################
	local ems,lvs
	if map == 1231 then
		ems = {-9971,-9975,-9967}--自己
	elseif map == 1221 then
		ems = {-7958,-9943,-9947,-9939,-9955,-9951}--自己
	...
	elseif map == 1202 then
		ems = {-7970,-7974,-7958,-8000,-7986,-7982}
	elseif map == 1201 then
		ems = {-7978,-7966,-7962,-7958}
	elseif map == 1042 then
		ems = {-2996,-3000,-3004,-2992}
	...
	elseif map == 1207 then
		ems = {-9934,-9931,-9927,-9907,-7958}
	elseif map == 1203 then
		ems = {-9903,-9899,-9895,-9891,-7958}
   ...
   elseif map == 5145 then
    ems = {300002}---
  elseif map == 5146 then
    ems = {300003}
  elseif map == 5147 then
    ems = {300004}
  elseif map == 5148 then
    ems = {300005}
  elseif map == 5149 then
    ems = {300006}
  elseif map == 5150 then
    ems = {300007}
  elseif map == 5151 then
    ems = {300008}
  elseif map == 5152 then
    ems = {300009}
  elseif map == 5153 then
    ems = {300010}
  elseif map == 5154 then
    ems = {300011}
  elseif map == 5155 then
    ems = {300012}
  elseif map == 5156 then
    ems = {300013}
  elseif map == 5157 then
    ems = {300014}
