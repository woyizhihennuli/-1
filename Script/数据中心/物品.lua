...
-- @Last Modified time: 2024-02-01 18:03:24
...
灵饰战斗属性={"气血回复效果","抗法术暴击等级","格挡值","法术防御","抗物理暴击等级","封印命中等级","抵抗封印等级","固定伤害","法术伤害","法术暴击等级","物理暴击等级","狂暴等级","穿刺等级","法术伤害结果","治疗能力"}
灵饰正常属性={"伤害","防御","气血","速度"}
--0914灵饰属性
灵饰属性.基础={--附属性
	 封印命中等级={[140]={a=14,b=21},[120]={a=12,b=18},[100]={a=10,b=15},[80]={a=8,b=12},[60]={a=6,b=9},[0]=4}
	...
	,速度={[140]={a=10,b=15},[120]={a=9,b=13},[100]={a=8,b=12},[80]={a=7,b=10},[60]={a=6,b=9},[0]=3}
	...
	,狂暴等级={[140]={a=10,b=15},[120]={a=9,b=13},[100]={a=8,b=12},[80]={a=7,b=10},[60]={a=6,b=9},[0]=3}
	,穿刺等级={[140]={a=10,b=15},[120]={a=9,b=13},[100]={a=8,b=12},[80]={a=7,b=10},[60]={a=6,b=9},[0]=4}
	,法术伤害结果={[140]={a=10,b=15},[120]={a=9,b=13},[100]={a=8,b=12},[80]={a=7,b=10},[60]={a=6,b=9},[0]=3}
	,治疗能力={[140]={a=10,b=15},[120]={a=9,b=13},[100]={a=8,b=12},[80]={a=7,b=10},[60]={a=6,b=9},[0]=3}
}
----主属性
灵饰属性.基础1={
	...
	,伤害={[140]={a=28,b=42},[120]={a=24,b=36},[100]={a=20,b=30},[80]={a=16,b=24},[60]={a=12,b=18},[0]=4}
	,
}
...
function 取内丹(类型)
    ...
    local 高级内丹 ={ "腾挪劲","玄武躯","龙胄铠","玉砥柱","碎甲刃","舍身击","通灵法","双星爆","催心浪","隐匿击","生死决","血债偿","神机步","电魂闪",}--"神机步","电魂闪","凛冽气","阴阳护",
   if 类型 == "高级"  then
...
function 绑定等级物品80()
	local n = {}
	n[1] = {"红缨枪","曲尖枪","锯齿矛","乌金三叉戟","火焰枪","墨杆金钩","玄铁矛","金蛇信","丈八点钢矛"}
	n[2] = {"青铜斧","开山斧","双面斧","双弦钺","精钢禅钺","黄金钺","乌金鬼头镰","狂魔镰","恶龙之齿"}
	n[3] = {"青铜短剑","铁齿剑","吴越剑","青锋剑","龙泉剑","黄金剑","游龙剑","北斗七星剑","碧玉剑"}
	n[4] = {"双短剑","镔铁双剑","龙凤双剑","竹节双剑","狼牙双剑","鱼骨双剑","赤焰双剑","墨玉双剑","梅花双剑"}
	n[5] = {"五色缎带","幻彩银纱","金丝彩带","无极丝","天蚕丝带","云龙绸带","七彩罗刹","缚神绫","九天仙绫"}
	n[6] = {"铁爪","天狼爪","幽冥鬼爪","青龙牙","勾魂爪","玄冰刺","青刚刺","华光刺","龙鳞刺"}
	n[7] = {"折扇","铁骨扇","精钢扇","铁面扇","百折扇","劈水扇","神火扇","阴风扇","风云雷电"}
	n[8] = {"细木棒","金丝魔棒","玉如意","点金棒","云龙棒","幽路引魂","满天星","水晶棒","日月光华"}
	n[9] = {"松木锤","镔铁锤","八棱金瓜","狼牙锤","烈焰锤","破甲战锤","震天锤","巨灵神锤","天崩地裂"}
	n[10] = {"牛皮鞭","牛筋鞭","乌龙鞭","钢结鞭","蛇骨鞭","玉竹金铃","青藤柳叶鞭","雷鸣嗜血鞭","混元金钩"}
	n[11] = {"黄铜圈","精钢日月圈","离情环","金刺轮","风火圈","赤炎环","蛇形月","子母双月","斜月狼牙"}
	n[12] = {"柳叶刀","苗刀","夜魔弯刀","金背大砍刀","雁翅刀","破天宝刀","狼牙刀","龙鳞宝刀","黑炎魔刀"}
	n[13] = {"曲柳杖","红木杖","白椴杖","墨铁拐","玄铁牛角杖","鹰眼法杖","腾云杖","引魂杖","碧玺杖"}
	n[14] = {"硬木弓","铁胆弓","紫檀弓","宝雕长弓","錾金宝弓","玉腰弯弓","连珠神弓","游鱼戏珠","灵犀望月"}
	n[15] = {"琉璃珠","水晶珠","珍宝珠","翡翠珠","莲华珠","夜灵珠","如意宝珠","沧海明珠","无量玉璧"}
	n[16] = {"钝铁重剑","桃印铁刃","赭石巨剑","壁玉长铗","青铜古剑","金错巨刃","惊涛雪","醉浮生","沉戟天戊"}
	n[18] = {"素纸灯","竹骨灯","红灯笼","鲤鱼灯","芙蓉花灯","如意宫灯","玲珑盏","玉兔盏","冰心盏"}
	n[17] = {"油纸伞","红罗伞","紫竹伞","锦绣椎","幽兰帐","琳琅盖","孔雀羽","金刚伞","落梅伞"}
	n[19] = {{"方巾","簪子"},{"布帽","玉钗",},{"面具","梅花簪子"},{"纶巾","珍珠头带"},{"缨络丝带","凤头钗"},{"羊角盔","媚狐头饰"},{"水晶帽","玉女发冠"},{"乾坤帽","魔女发冠"},{"黑魔冠","七彩花环"}}
	n[20] = {"护身符","五色飞石","珍珠链",{"骷髅吊坠","苍魂珠"},{"江湖夜雨","九宫坠"},{"荧光坠子","高速之星"},{"风月宝链","八卦坠"},{"碧水青龙","鬼牙攫魂"},{"万里卷云","疾风之铃"}}
	n[21] = {{"布裙","布衣"},{"丝绸长裙","皮衣"},{"五彩裙","鳞甲"},{"龙鳞羽衣","锁子甲"},{"天香披肩","紧身衣"},{"金缕羽衣","钢甲"},{"霓裳羽衣","夜魔披风"},{"流云素裙","龙骨甲"},{"七宝天衣","死亡斗篷"}}
	n[22] = {"腰带","缎带","银腰带",{"水晶腰带","玉树腰带"},{"琥珀腰链","白面狼牙"},{"乱牙咬","魔童大牙"},{"攫魂铃","双魂引"},{"兽王腰带","百窜云"},{"八卦锻带","圣王坠"}}
	n[23] = {"布鞋","牛皮靴","马靴","侠客履","神行靴","绿靴","追星踏月","九州履","万里追云履"}
	n[24] = {"竹编护腕","皮腕","针腕","骨镯","青铜护腕","玛瑙护腕","琉璃护腕","镂空银镯","笼玉镯"}
	n[25] = {"竹编脖环","钢圈","荆棘环","骨环","青铜颈环","玛瑙石环","琉璃环","九曲环","笼玉环"}
	n[26] = {"竹藤甲","皮甲","刺甲","骨排甲","青铜披甲","玛瑙软甲","琉璃罩甲","连环铠甲","笼玉甲"}
	return n
end
...
wds[13] = 0x663fc75A
wds[14] = 500
elseif wd == "强化技能丹" then
wds[1] = "随机升级一种强化技能，战斗力大幅度提升！"
wds[2] = 9
wds[3] = 1
wds[4] = 1
wds[11] = "item.wdf"
...
wds[1] = "基础经验额外增加2倍,可以与双倍、精修、双倍经验丹同时存在,每次使用获得1小时有效时间。无法冻结、无法叠加使用。"
wds[2] = 4
wds[3] = 2
wds[4] = 0
wds[11] = "item.wd1"
...
wds[1] = "基础经验额外增加3倍,可以与双倍、精修、双倍经验丹同时存在,每次使用获得1小时有效时间。无法冻结、无法叠加使用。"
wds[2] = 4
wds[3] = 2
wds[4] = 0
wds[11] = "item.wd1"
...
elseif wd == "装备无级别卷" then
wds[1] = "可以给装备添加无级别限制特效"
wds[2] = 102
wds[3] = 3
wds[4] = 0
wds[11] = "物品图标.wdf"
...
wds[13] = 0x49B4F6DC
elseif wd == "潜能果" then
wds[1] = "传说中激发人物属性的潜能，吃了吊变的又大又黑又粗，具有治疗肾虚的作用，可延年益寿。食用后可以增加人物1点潜能（不可以对召唤兽使用），但每个人物最多食用对应等级阶段的数量"
wds[2] = 1
wds[3] = 10
wds[4] = 1
wds[8] = 1
...
wds[12] = 0x9724BCB0
wds[13] = 0xFE37E4E0
elseif wd == "随机宝石一" then
wds[1] = "散发着宝石的光华，右键打开，可以获得1~5级随机宝石一颗"
wds[2] = 1002
wds[3] = 1
wds[4] = 3
wds[8] = 3
...
wds[12] = 0x9724BCB0
wds[13] = 0xFE37E4E0
elseif wd == "随机宝石二" then
wds[1] = "散发着宝石的光华，右键打开，可以获得4~8级随机宝石一颗"
wds[2] = 1002
wds[3] = 1
wds[4] = 3
wds[8] = 3
...
wds[12] = 0x9724BCB0
wds[13] = 0xFE37E4E0
elseif wd == "随机宝石三" then
wds[1] = "散发着宝石的光华，右键打开，可以获得5~10级随机宝石一颗"
wds[2] = 1002
wds[3] = 1
wds[4] = 3
wds[8] = 3
...
wds[12] = 0x9724BCB0
wds[13] = 0xFE37E4E0
elseif wd == "随机宝石四" then
wds[1] = "散发着宝石的光华，右键打开，可以获得8~12级随机宝石一颗"
wds[2] = 1002
wds[3] = 1
wds[4] = 3
wds[8] = 3
...
elseif wd == "神灵宝珠" then
wds[1] = "蕴含天地精华的宝珠，可为一件人物装备添加无级别效果。（右键使用）注意:右键使用道具就消失"
wds[2] = 4
wds[3] = 1
wds[4] = 0
wds[11] = "物品图标.wdf"
...
elseif wd == "仙灵宝珠" then
wds[1] = "蕴含天地精华的宝珠，可为一件人物灵饰添加无级别效果。（右键使用）注意:右键使用道具就消失"
wds[2] = 4
wds[3] = 1
wds[4] = 0
wds[11] = "物品图标.wdf"
...
wds[13] = 0x365A8D06
elseif wd == "蟠龙玉璧" then
wds[1] = "增加自身防御和法防=法宝层数*20+100的数值"
wds[2] = 1000
wds[3] = 4
wds[4] = 2
wds[5] = 0
...
wds[13] = 0xDBCC855E
elseif wd == "小额银票" then
wds[1] = "大唐年间，李记钱庄发行的一种银票，可获得一亿两银子。"
wds[2] = "银票"
wds[3] = 3
wds[4] = 0
wds[11] = "item.wdf"
...
wds[1] = "内含一套6件50级装备，根据玩家角色开出自身对应的装备，随机属性，衣服和武器必出双加。"
wds[2] = "装备礼包"
wds[3] = 1
wds[4] = 0
wds[11] = "item.wdf"
...
wds[12] = 0x249D07A5
wds[13] = 0x25D608E8
elseif wd == "扶摇万里碎片" then
wds[1] = "积攒999个，可找老G换特殊技能扶摇万里。"
wds[2] = 1003
wds[3] = 11
wds[4] = 0
wds[8] = 1
...
wds[13] = 0xC1B54E00
elseif wd == "缚妖索" then
wds[1] = "天师的法宝，战斗中祭起后将目标牢牢捆缚住，使其的逃跑成功率降低。"
wds[2] = 1000
wds[3] = 1
wds[4] = 1
wds[5] = 1
...
wds[13] = 0xC1D43099
elseif wd == "降魔斗篷" then
wds[1] = "采天蚕之丝，辅以七彩云锻为其缝制的斗篷，披上它有几率抵挡部分法术伤害。"
wds[2] = 1000
wds[3] = 2
wds[4] = 1
wds[5] = 0
...
wds[13] = 0xC1B54E00
elseif wd == "捆仙绳" then
wds[1] = "天庭法宝，专为缉拿神仙所制，材料不知为何物，柔韧结实，一旦被捆则降低目标的逃跑成功率。"
wds[2] = 1000
wds[3] = 2
wds[4] = 1
wds[5] = 1
...
wds[13] = 0xE498691F
elseif wd == "神木宝鼎" then
wds[1] = "神木林祭师祭天地所用之物。佩带在战斗中此鼎临时提升增加大量法术伤害。"
wds[2] = 1000
wds[3] = 2
wds[4] = 1
wds[5] = 0
