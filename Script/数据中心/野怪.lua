...
-- @Last Modified time: 2023-06-25 14:42:22
--======================================================================--
-- @作者: GGE研究群: 342119466
-- @创建时间:   2018-03-03 02:34:19
-- @Last Modified time: 2023-01-01 04:46:33
...
---嘎嘎  跨服
    elseif dr == 300002 then
		drs = {"魔化·子鼠","超级神鼠",175,2,2500,2500,5500000,2500,2500,1500,2,nil,nil,{"须弥真言","再生","奔雷咒","神佑复生"},nil,true,0}
	elseif dr == 300003 then
		drs = {"魔化·丑牛","超级神牛",175,2,2500,2500,5500000,2500,2500,1500,2,nil,nil,{"须弥真言","再生","奔雷咒","神佑复生"},nil,true,0}
	elseif dr == 300004 then
		drs = {"魔化·寅虎","超级神虎",175,2,2500,2500,5500000,2500,2500,1500,2,nil,nil,{"须弥真言","再生","奔雷咒","神佑复生"},nil,true,0}
	elseif dr == 300005 then
		drs = {"魔化·卯兔","超级神兔",175,2,2500,2500,5500000,2500,2500,1500,2,nil,nil,{"须弥真言","再生","奔雷咒","神佑复生"},nil,true,0}
	elseif dr == 300006 then
		drs = {"魔化·辰龙","超级神龙",175,2,2500,2500,5500000,2500,2500,1500,2,nil,nil,{"须弥真言","再生","奔雷咒","神佑复生"},nil,true,0}
	elseif dr == 300007 then
		drs = {"魔化·巳蛇","超级神蛇",175,2,2500,2500,5500000,2500,2500,1500,2,nil,nil,{"须弥真言","再生","奔雷咒","神佑复生"},nil,true,0}
	elseif dr == 300008 then
		drs = {"魔化·午马","超级神马",175,2,2500,2500,5500000,2500,2500,1500,2,nil,nil,{"须弥真言","再生","奔雷咒","神佑复生"},nil,true,0}
	elseif dr == 300009 then
		drs = {"魔化·未羊","超级神羊",175,2,2500,2500,5500000,2500,2500,1500,2,nil,nil,{"须弥真言","再生","奔雷咒","神佑复生"},nil,true,0}
	elseif dr == 300010 then
		drs = {"魔化·申猴","超级神猴",175,2,2500,2500,5500000,2500,2500,1500,2,nil,nil,{"须弥真言","再生","奔雷咒","神佑复生"},nil,true,0}
	elseif dr == 300011 then
		drs = {"魔化·酉鸡","超级神鸡",175,2,2500,2500,5500000,2500,2500,1500,2,nil,nil,{"须弥真言","再生","奔雷咒","神佑复生"},nil,true,0}
	elseif dr == 300012 then
		drs = {"魔化·戌狗","超级神狗",175,2,2500,2500,5500000,2500,2500,1500,2,nil,nil,{"须弥真言","再生","奔雷咒","神佑复生"},nil,true,0}
	elseif dr == 300013 then
		drs = {"魔化·亥猪","超级神猪",175,2,2500,2500,5500000,2500,2500,1500,2,nil,nil,{"须弥真言","再生","奔雷咒","神佑复生"},nil,true,0}
	elseif dr == 300014 then
		drs = {"暗藏乾坤","谛听",175,2,2500,2500,5500000,2500,2500,1500,2,nil,nil,{"须弥真言","再生","奔雷咒","神佑复生"},nil,true,0}
