...
-- @Last Modified time: 2023-05-05 20:33:27
...
function 取随机法术新(数量)
	local 法术={"水漫金山","地狱烈火","奔雷咒","泰山压顶","龙卷雨击","飞砂走石","落叶萧萧","三昧真火","龙腾","烈火","水攻","落岩","雷击","五行制化","五雷咒","阎罗令","雨落寒沙","月光"}
	local 返回组={}
	for n=1,数量 do
		返回组[n]=法术[取随机数(1,#法术)]
	end
...
function 取随机法术鬼(数量)
	local 法术={"尸腐毒","地涌金莲","夺命咒","阎罗令","判官令","百爪狂杀"}
	local 返回组={}
	for n=1,数量 do
		返回组[n]=法术[取随机数(1,#法术)]
	end
...
function 取法术技能(jn)
  ...
  elseif jn == "破碎无双" then
	...
	elseif jn == "进击必杀" then
		...
		jns[8] = 0X0000009F
	elseif jn == "进击法爆" then
		jns[1] = "宠物技能必须有法爆或者高级法爆的时候才能生效,提升本身必杀几率的百分之5"--"第2回合及以后进入战斗时,提升10%6的法术暴击几率持续5回合,且逐回合臧少20%效果。"
		jns[3] = 7
		jns[6] = "物品图标.wdf"
		jns[7] = 0X000000A0
		jns[8] = 0X000000A0
	...
	elseif jn == "高级进击法爆" then
		jns[1] = "宠物技能必须有法爆或者高级法爆的时候才能生效,提升本身必杀几率的百分之10"--"第2回合及以后进入战斗时,提升20%的法术暴击几率持续5回合,且逐回合臧少20%效果。"
		jns[3] = 7
		jns[6] = "物品图标.wdf"
		jns[7] = 0X000000A3
		jns[8] = 0X000000A3
	elseif jn == "扶摇万里" then
		jns[1] = "(鲲鹏专属技能)法术攻击多个目标，按等级附加一定的法术伤害，攻击人数=10人（抟扶摇而上者九万里。）"
		jns[3] = 4
		jns[6] = "物品图标.wdf"
		jns[7] = 0xAABBDDA1
		jns[8] = 0xAABBDDA1
