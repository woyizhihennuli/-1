...
-- @Last Modified time: 2022-10-06 12:30:06
...
Q_门派法术={
  大唐官府={"横扫千军","后发制人","破釜沉舟","杀气诀"}
  ,化生寺={"推气过宫","活血","慈航普渡","金刚护体","金刚护法","唧唧歪歪"}
  ,方寸山={"碎甲符","定身符","失心符","五雷咒","落雷符","分身术"}
  ,女儿村={"一笑倾城","满天花雨","红袖添香","雨落寒沙"}
  ,神木林={"落叶萧萧","密润","风卷残云"}
  ,盘丝洞={"含情脉脉","瘴气","魔音摄魂","盘丝阵","幻镜术","天罗地网"}
  ,魔王寨={"火甲术","摇头摆尾","三昧真火","飞砂走石","牛劲"}
  ,狮驼岭={"连环击","鹰击","狮搏","象形","变身"}
  ,阴曹地府={"阎罗令","判官令","百爪狂杀","六道无量","尸腐毒"}
  ,无底洞={"地涌金莲","夺命咒","金身舍利","摧心术","明光宝烛","同舟共济"}
  ,天宫={"天雷斩","五雷轰顶","雷霆万钧","天神护体","天神护法"}
  ,普陀山={"普渡众生","波澜不惊","晶清诀","五行制化","灵动九天"}
  ,凌波城={"天崩地裂","翻江搅海","碎星诀","浪涌"}
  ,五庄观={"日月乾坤","飘渺式","烟雨剑法","生命之泉"}
  ,龙宫={"龙卷雨击","龙腾","二龙戏珠","亢龙归海","雷浪穿云"}
}
